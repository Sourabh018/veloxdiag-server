...
public class IndexAdvisorController {
    ...
    public List<IndexAdvisorFinding> getCandidates(@RequestParam(required = false) String applicationName) {
        return indexAdvisorService.analyzeCandidates(applicationName);
    }
}